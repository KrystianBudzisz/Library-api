...
class RentalServiceTest {
    ...
    void testCreateRental() {
        // Utwórz dane wejściowe dla CreateRentalCommand
        ...
        // Zdefiniuj zachowanie mocków dla repository
    ...
    void testReturnRental() {
        ...
        // Utwórz Rental oczekiwany do zwrotu
        ...
        // Utwórz Rental oczekiwany po zwrocie
    ...
    void testGetClientRentals() {
        ...
        // Sprawdź, czy metoda findByClientId() została wywołana na repository
        Mockito.verify(rentalRepository, Mockito.times(1)).findByClientId(1L);

        // Sprawdź, czy zwrócona lista RentalDto ma poprawne wartości
